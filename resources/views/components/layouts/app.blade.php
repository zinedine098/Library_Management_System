...
<body class="font-sans antialiased bg-slate-50">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-slate-900 text-white flex-shrink-0 hidden md:block">
            <div class="p-6">
                <a href="{{ route('dashboard') }}" class="text-xl font-bold">LibLoan Admin</a>
            </div>
            <nav class="mt-6">
            ...
            <header class="bg-white shadow-sm border-b border-slate-200">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center md:hidden">
                        <!-- Mobile menu button -->
                        <button type="button" class="text-slate-500 hover:text-slate-700" onclick="document.getElementById('mobile-menu').classList.toggle('hidden')">
